...
#  Created by Design Compiler write_sdc on Fri Sep 15 17:17:06 2000
...
set_clock_latency -source  0.05 -early -rise [get_clocks {clk}]
set_clock_latency -source  0.01 -early -fall [get_clocks {clk}]
set_clock_latency -source  0.06 -late -rise [get_clocks {clk}]
set_clock_latency -source  0.08 -late -fall [get_clocks {clk}]
