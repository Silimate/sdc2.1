...
set_timing_derate -data -cell_delay -late 1.5 [get_cells {invbd7G5B1I1}]
set_timing_derate -clock -cell_delay -late 1.5 [get_cells {invbd7G5B1I1}]
...
set_timing_derate -cell_delay -net_delay -late 1.05 [get_cells top/H1]
set_timing_derate -cell_delay -net_delay -late 1.05 [get_cells top/H1]
set_timing_derate -increment -late 0.4 [get_cells u1/u252]
set_timing_derate -increment -early 0.3 [get_cells u1/u252]
###############################################################################
